...
(0, 'The Sun', 'A Best Place To Stay', 'lehuyhoang0101@gmail.comcom', '03291568810329156881', 'Dai hoc BKHN');
...
(1, 'Hoang', 'images/person_1.jpg', 'Khách sạn tuy được xây dựng lâu, tuy nhiên, khá sạch sẽ. Diện tích phòng lớn, giá cả hợp lý.'),
(2, 'Duc', 'images/person_2.jpg', 'Phòng no smoking mà ngập tràn mùi thuốc lá. Khi yêu cầu đổi phòng có cửa sổ thì tính thêm phí 40usd một đêm. Ăn sáng thì đưa cho khách sữa chua đã hết hạn hơn 5 ngày.'),
(3, 'Tung', 'images/person_3.jpg', 'Địa điểm là tốt. Bên cạnh sự thuận tiện của sông. Phòng lớn. Giá là rất tốt đẹp.'),
(4, 'Cuong', 'images/person_1.jpg', 'Bữa sáng nghèo nàn so với 1 khách sạn 3 sao trung tâm. Phòng nhỏ, chật chội, nội thất cũ kĩ và không có cửa sổ.');
...
(2, 'admin', '$2y$10$OWR1KuqTLN5/BF61qURhDu8ShbBUud6j3gnoYdxURtSBt3zkZ3Ziq');
