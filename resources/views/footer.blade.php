		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 text-center text-md-left">
					...
					<p class="color-grey mt-4">Av11 Street<br>Hanoi</p>
				</div>
				...
				<div class="col-md-5 mt-4 mt-md-0 text-center text-md-left logos-footer">
					...
					<p class="color-grey mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
					tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
					quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
					consequat.</p>
					<img src="source/images/Paypal.png" alt="Paypal"  title="Paypal">
					<img src="source/images/Master-card.png" alt="Mastercard" title="Mastercard">
					<img src="source/images/Visa.png" alt="Visa" title="Visa">
				</div>
			</div>	
		</div>	
	</div>
