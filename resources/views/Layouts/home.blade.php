...
<div class="section background-dark over-hide">	
		...
		<div class="slideshow">
			...
			<div class="slide parallax-top">
				<figure class="slide__figure">
					<div class="slide__figure-inner">
						<div class="slide__figure-img" style="background-image: url(source/images/2.jpg)"></div>
						<div class="slide__figure-reveal"></div>
					</div>
				</figure>
			</div>	
			...
			<div class="row justify-content-center">
				...
				<div class="col-md-6">
					<div class="room-box background-white">
						...
						<div class="room-img">
							<img src="source/images/room1.jpg">
						</div>
				...
				<div class="col-md-6 mt-4 mt-md-0">
					<div class="room-box background-white">
						...
						<div class="room-img">
							<img src="source/images/room2.jpg">
						</div>
						<div class="room-box-in">
				...
				<div class="col-md-6 mt-4">
					<div class="room-box background-white">
						...
						<div class="room-img">
							<img src="source/images/room3.jpg">
						</div>
						<div class="room-box-in">
				...
				<div class="col-md-6 mt-4">
					<div class="room-box background-white" >
						...
						<div class="room-img">
							<img src="source/images/room4.jpg">
						</div>
						<div class="room-box-in">
	...
	<div class="section padding-top-bottom-big over-hide">
		 <div class="parallax" style="background-image: url('source/images/5.jpg')"></div> 		
